        ...
        implements Loggable
{
            ...
            Function<V, H> attributeToPropertyConvert)
    {
        ...
        {/*
            var selectedControlWrapper = setupPane.getSetupStage().getSelectedControlWrapper();
            if(selectedControlWrapper == null)
            {
                return;
            }

            var selectedControlList = selectedControlWrapper.getControlMainPage().getSelectionManager().getList();

            for(var selectedControl : selectedControlList)
            {
                selectedControl.getStateMap().getAllAttributesOfType()
